...
<div class="container">
	<div class="row">
		<div class="col-12  pt-5">
			...
			<div class="text-left"><a href="<?php echo config('app.url').'/testapp/public/product';?>" class="btn btn-outline-primary">Product List</a></div>

			<form id="add-frm" method="POST" action="createProduct" class="border p-3 mt-2">
